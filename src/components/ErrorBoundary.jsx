    ...
    if (this.state.hasError) {
      return (
        <div style={{
          ...
          fontFamily: 'Inter, sans-serif', color: '#161b22', padding: 24, textAlign: 'center',
        }}>
          <div style={{ fontSize: 18, fontWeight: 700 }}>Something went wrong.</div>
          <div style={{ fontSize: 14, color: '#57606f', maxWidth: 380 }}>
          ...
          <button
            ...
            style={{
              ...
              background: '#0f9d63', color: '#fff', fontWeight: 600, cursor: 'pointer',
            }}
          >
            Reload
          </button>

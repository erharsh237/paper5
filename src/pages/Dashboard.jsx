...
import { subscribeSprints, closeSprint, reopenSprint, deleteSprint } from '../lib/sprints'
                  ...
                  return (
                    <div key={sprint.id} className="dash-sprint-card">
                      ...
                      <div className="dash-sprint-card-header">
                        ...
                        {/* Admin Delete Sprint Dustbin */}
                        {canAddKanbanItems && (
                          <button
                            type="button"
                            onClick={async (e) => {
                              e.stopPropagation()
                              const confirmed = window.confirm(`Delete Sprint ${sprint.number}? Deadlines assigned to this sprint will be unassigned.`)
                              if (!confirmed) return
                              try {
